...
func artefactTestRecord(t *testing.T) domain.InterfaceRecord {
	t.Helper()
...
func withArtefact(r domain.InterfaceRecord, id fetchdomain.ArtefactIdentity) domain.InterfaceRecord {
