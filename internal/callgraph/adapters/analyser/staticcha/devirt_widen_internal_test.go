...
func TestDevirt_WidensToBuiltDependencyBody(t *testing.T) {
	...
	nodes, edges := a.devirtualizeSingleImplementer(context.Background(), prog, orderedFunctions(closedFunctionSet(prog)), membershipByPrefix(coord), fset, sourceRoots{}, nil, nil)
