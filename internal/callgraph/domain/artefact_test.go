...
func artefactTestRecord(t *testing.T) domain.CallGraphRecord {
	t.Helper()
...
func withArtefact(r domain.CallGraphRecord, id fetchdomain.ArtefactIdentity) domain.CallGraphRecord {
