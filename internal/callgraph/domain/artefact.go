...
//
// It is a free function rather than a method because CallGraphRecord is aliased into
...
func RecordArtefactIdentity(r CallGraphRecord) (fetchdomain.ArtefactIdentity, error) {
	...
	if err != nil {
		return fetchdomain.ArtefactIdentity{}, fmt.Errorf("reading the artefact identity of the call graph for %s: %w", r.Coordinate, err)
	}
	return id, nil
}
