...
func TestRunScanShow_ReportsTheUnreadableRunItWasAskedFor(t *testing.T) {
	...
	var out bytes.Buffer
	if err := runScanShow(t.Context(), "vscan-bad", false, fake, nil, nil, nil, nil, &out, io.Discard); err != nil {
...
func TestRunScanShow_JSONNamesTheRun(t *testing.T) {
	...
	var out bytes.Buffer
	if err := runScanShow(t.Context(), "vscan-bad", true, fake, nil, nil, nil, nil, &out, io.Discard); err != nil {
...
func TestRunScanShow_OtherFailuresStillAbort(t *testing.T) {
	t.Run("read failure", func(t *testing.T) {
		...
		var out bytes.Buffer
		if err := runScanShow(t.Context(), "vscan-x", false, fake, nil, nil, nil, nil, &out, io.Discard); err == nil {
	...
	t.Run("not found", func(t *testing.T) {
		fake := testfakes.NewFakeQueryScanRuns()
		var out bytes.Buffer
		if err := runScanShow(t.Context(), "vscan-absent", false, fake, nil, nil, nil, nil, &out, io.Discard); err == nil {
