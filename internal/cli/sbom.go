...
func ensureProjectWalkForSBOM(ctx context.Context, ctr *Container, force, stdlibFromGoMod bool, policyPath string, stderr io.Writer) (string, error) {
	...
	if werr := runWalkProject(ctx, gomodPath, force, true, 0, "", policyPath, false, scopeCode, walkdomain.WalkDepthFull, "", false, stdlibFromGoMod, progress, ctr.ExecuteWalk, io.Discard, stderr); werr != nil {
