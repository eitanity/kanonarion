...
func TestRunVulnShow_WithWalkID(t *testing.T) {
	...
	var buf bytes.Buffer
	if err := runVulnShow(context.Background(), "example.com/app@v1.0.0", fixtureWalkID, false, false, uc, testfakes.NewFakeQueryScanRuns(), testfakes.NewFakeQueryWalks(), &buf); err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	out := buf.String()
	if !strings.Contains(out, "example.com/app@v1.0.0") {
...
func TestRunVulnShow_NoWalkID(t *testing.T) {
	...
	var buf bytes.Buffer
	if err := runVulnShow(context.Background(), "example.com/app@v1.0.0", "", false, false, uc, testfakes.NewFakeQueryScanRuns(), testfakes.NewFakeQueryWalks(), &buf); err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestRunVulnShow_SurfacesRemediation(t *testing.T) {
	...
	var buf bytes.Buffer
	if err := runVulnShow(context.Background(), "github.com/gorilla/csrf@v1.7.3", "", false, false, uc, testfakes.NewFakeQueryScanRuns(), testfakes.NewFakeQueryWalks(), &buf); err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	out := buf.String()
...
func TestRunVulnShow_FixedVersionRendered(t *testing.T) {
	...
	var buf bytes.Buffer
	if err := runVulnShow(context.Background(), "github.com/foo/bar@v1.0.0", "", false, false, uc, testfakes.NewFakeQueryScanRuns(), testfakes.NewFakeQueryWalks(), &buf); err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	out := buf.String()
...
func TestRunVulnShow_NotFound(t *testing.T) {
	...
	var buf bytes.Buffer
	err := runVulnShow(context.Background(), "example.com/missing@v9.9.9", "", false, false, uc, testfakes.NewFakeQueryScanRuns(), testfakes.NewFakeQueryWalks(), &buf)
	if err == nil {
		t.Fatal("expected error, got nil")
	}
...
func TestRunVulnShow_DoesNotAttributeAnotherWalksFailure(t *testing.T) {
	...
	err := runVulnShow(context.Background(), "example.com/failed@v1.0.0",
		"01JWALKPARTIAL00000000001", false, false, uc, runs, testfakes.NewFakeQueryWalks(), &buf)
	if err == nil {
...
func TestRunVulnShow_WalkNeverScanned(t *testing.T) {
	...
	var buf bytes.Buffer
	err := runVulnShow(context.Background(), "example.com/failed@v1.0.0",
		"01JWALKPARTIAL00000000001", false, false, uc, testfakes.NewFakeQueryScanRuns(), testfakes.NewFakeQueryWalks(), &buf)
	if err == nil {
